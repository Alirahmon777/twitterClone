...
const NotFound = () => {
  ...
  return (
    <div className="min-w-full min-h-screen bg-blue-100 flex items-center p-5 lg:p-20 overflow-hidden relative">
      <div className="flex-1 min-h-full min-w-full rounded-3xl bg-white shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left">
        <div className="w-full md:w-1/2">
          ...
          <div className="mb-10 md:mb-20 text-gray-600 font-light">
            <h1 className="font-black uppercase text-3xl lg:text-5xl text-[#1DA1F2] mb-10">
              You seem to be lost!
            </h1>
          ...
          <div className="mb-20 md:mb-0">
            <button
              onClick={goBack}
              className="text-lg font-light outline-none focus:outline-none transform transition-all hover:scale-110 text-[#1DA1F2] hover:text-blue-400 hover:font-medium"
            >
